    ...
    public static class HostBuilderExtensions
    {
            ...
            where TStartup : class, IStartup
        {
            return hostBuilder.ConfigureServices((hostContext, services) =>
            {
                ...
                services.AddSingleton<IApplicationBuilder, ApplicationBuilder>(serviceProvider => new ApplicationBuilder(serviceProvider));
        ...
        public static IHost BuildAndRunConfigurableHostAsync(this IHostBuilder hostBuilder, CancellationToken cancellationToken = default)
        {
            var host = hostBuilder.BuildConfigurableHost();

            Task.Run(() => host.RunAsync(cancellationToken), cancellationToken);
